...
##
## matpy.py:
## Auxiliary functions that are used multiple times in the codes.
##
## -------------------------
...
class nfun(object):
    ...
    def __init__(self,ntype,npar=1.0,mshift=0.0,vdims=(),vecweights = False , mask=False,eps=0.1,delta=1.0,l1eps_par=0.1, p=1.5):
        ...
        'inpaint','l1_2','l1_2-svd','l0','l0-svd','l1-svd','I_linfty','I0','IN','IP','zero','usprox','l1eps','lp']
...
class gconv(object):
    ...
    def fwd(self,c):
        ...
        return scipy.signal.convolve2d(c,self.k,mode='same',boundary='fill')
